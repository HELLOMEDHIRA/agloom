...
export const SLASH_HINTS: Record<string, string> = {
  ...
  '/think': 'Show or hide dim inline reasoning trace (all turns)',
...
export const SLASH_HELP_LINES: string[] = [
  ...
  '  /think             Show or hide dim inline reasoning trace',
  '  Ctrl+Y             Same as /think',
  '  Ctrl+[/] PgUp/PgDn  Scroll chat transcript (sidebar: PgUp/PgDn only)',
