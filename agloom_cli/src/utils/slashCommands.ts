...
export const SLASH_HINTS: Record<string, string> = {
  ...
  '/think': 'Toggle thinking trace: current turn while streaming, else completed turns',
...
export const SLASH_HELP_LINES: string[] = [
  ...
  '  /think             Toggle thinking: in-flight trace vs one live line; else completed turns',
  '  Ctrl+Y             Same as /think (in-flight vs completed thinking)',
