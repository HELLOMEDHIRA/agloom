/** Keep Zod wire schemas and CLI reducer catalogue aligned (agloom_cli only). */

import { readFileSync } from 'node:fs'
import { join } from 'node:path'

import { AGP_WIRE_DATA_EVENT_TYPES, AGP_WIRE_DATA_SCHEMAS } from '../types/agpWireParse.js'
import { KNOWN_AGP_EVENT_TYPES } from '../types/knownAgpEventTypes.js'
...
describe('AGP catalogue sync (CLI)', () => {
