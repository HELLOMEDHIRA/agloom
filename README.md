...
| Show progress     | Token streaming, trace steps, and model reasoning on the wire ([guide](https://agloom.readthedocs.io/_packages/agloom/features/thinking-events/)) |
...
| [Thinking & reasoning](https://agloom.readthedocs.io/_packages/agloom/features/thinking-events/) | Trace steps vs model reasoning on the wire |
